...
func NewServer(port uint, guardianCheck *health.GuardianCheck, logger *zap.Logger, repository storage.Storager, pprofEnabled bool, alertClient alert.AlertClient, checks ...healthcheck.Check) *Server {
