...
// TODO pass a full VAA (instead of separate fields)
// TODO Skip messages that have not been generated by the portal token bridge
func (c *Consumer) updateSourceTx(
	ctx context.Context,
	chainId sdk.ChainID,
	emitter string,
	sequence string,
	...
	//TODO remove this after we pass full VAAs to this function
	vaaId := fmt.Sprintf("%d/%s/%s", chainId, emitter, sequence)
	...
	err = c.upsertDocument(ctx, vaaId, chainId, txHash, txDetail, txStatus)
	if err != nil {
...
// TODO pass a full VAA (instead of separate fields)
func (c *Consumer) upsertDocument(
	ctx context.Context,
	vaaId string,
	chainId sdk.ChainID,
	txHash string,
	...
	_, err := c.globalTransactions.UpdateByID(ctx, vaaId, update, opts)
	if err != nil {
