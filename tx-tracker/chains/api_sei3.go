...
// func seiTxSearchExtractor2(tx *cosmosTxSearchResponse, logs []cosmosLogWrapperResponse) (*seiTx, error) {
// 	var sender string
// 	for _, l := range logs {
...
// func fetchSeiDetail2(ctx context.Context, baseUrl string, sequence, timestamp, srcChannel, dstChannel string) (*seiTx, error) {
