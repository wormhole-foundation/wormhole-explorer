...
import {
  HandleEvmLogs,
  HandleEvmLogsConfig,
} from "../../src/domain/actions/HandleEvmLogs";
...
const givenEvmLogs = (length: number, matchingFilterOnes: number) => {
  ...
  for (let i = 0; i < length; i++) {
    let address =
      "0x392f472048681816e91026cd768c60958b55352add2837adea9ea6249178b8a8";
    ...
    evmLogs.push({
      ...
      blockHash:
        "0x1a07d0bd31c84f0dab36eac31a2f3aa801852bf8240ffba19113c62463f694fa",
      address: address,
      removed: false,
      ...
      transactionHash:
        "0x2077dbd0c685c264dfa4e8e048ff15b03775043070216644258bf1bd3e419aa8",
