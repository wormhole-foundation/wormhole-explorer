import { PollNearConfig, PollNearMetadata, PollNear } from "../../../../src/domain/actions";
...
describe("PollNear", () => {
  ...
  it("should be able to read logs from latest block when no fromBlock is configured", async () => {
    ...
    givenNearRepository(currentHeight, txs);
    givenMetadataRepository();
    givenStatsRepository();
    givenPollNearTxs();

    await whenpollNearLogsStarts();
...
const whenpollNearLogsStarts = async () => {
