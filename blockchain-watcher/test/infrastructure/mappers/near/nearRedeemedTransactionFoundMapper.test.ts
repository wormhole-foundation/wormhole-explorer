import { nearRedeemedTransactionFoundMapper } from "../../../../src/infrastructure/mappers/near/nearRedeemedTransactionFoundMapper";
import { describe, it, expect } from "@jest/globals";

describe("nearRedeemedTransactionFoundMapper", () => {
  ...
  it("should be able to map log to algorandRedeemedTransactionFoundMapper", async () => {
    // When
    const result = nearRedeemedTransactionFoundMapper(tx);
  ...
  logs: [
    {
      ...
      outcome: {
        ...
        metadata: {
          version: 3,
          gas_profile: [
            { cost_category: "ACTION_COST", cost: "FUNCTION_CALL_BASE", gas_used: "600000000000" },
            { cost_category: "ACTION_COST", cost: "FUNCTION_CALL_BYTE", gas_used: "5249973032" },
            { cost_category: "ACTION_COST", cost: "NEW_ACTION_RECEIPT", gas_used: "470125429248" },
            ...
            { cost_category: "WASM_HOST_COST", cost: "KECCAK256_BASE", gas_used: "5879491275" },
            { cost_category: "WASM_HOST_COST", cost: "KECCAK256_BYTE", gas_used: "3950683320" },
            { cost_category: "WASM_HOST_COST", cost: "PROMISE_RETURN", gas_used: "560152386" },
            {
              cost_category: "WASM_HOST_COST",
              cost: "READ_CACHED_TRIE_NODE",
              gas_used: "11400000000",
            },
            { cost_category: "WASM_HOST_COST", cost: "READ_MEMORY_BASE", gas_used: "46977537600" },
            { cost_category: "WASM_HOST_COST", cost: "READ_MEMORY_BYTE", gas_used: "10860408381" },
            {
              cost_category: "WASM_HOST_COST",
              cost: "READ_REGISTER_BASE",
              gas_used: "15102991116",
            },
            { cost_category: "WASM_HOST_COST", cost: "READ_REGISTER_BYTE", gas_used: "231029328" },
            {
              cost_category: "WASM_HOST_COST",
            ...
            { cost_category: "WASM_HOST_COST", cost: "STORAGE_READ_BASE", gas_used: "56356845750" },
            {
              cost_category: "WASM_HOST_COST",
            ...
            { cost_category: "WASM_HOST_COST", cost: "UTF8_DECODING_BASE", gas_used: "9335337183" },
            {
              cost_category: "WASM_HOST_COST",
              cost: "UTF8_DECODING_BYTE",
              gas_used: "23618018799",
            },
            { cost_category: "WASM_HOST_COST", cost: "WASM_INSTRUCTION", gas_used: "319104269088" },
            { cost_category: "WASM_HOST_COST", cost: "WRITE_MEMORY_BASE", gas_used: "25234153749" },
            { cost_category: "WASM_HOST_COST", cost: "WRITE_MEMORY_BYTE", gas_used: "6515262624" },
            {
              cost_category: "WASM_HOST_COST",
    ...
    },
    {
      ...
      outcome: {
        ...
        metadata: {
          version: 3,
          gas_profile: [
            { cost_category: "ACTION_COST", cost: "NEW_ACTION_RECEIPT", gas_used: "108059500000" },
            { cost_category: "ACTION_COST", cost: "NEW_DATA_RECEIPT_BYTE", gas_used: "137696088" },
            ...
            { cost_category: "WASM_HOST_COST", cost: "READ_MEMORY_BASE", gas_used: "26098632000" },
            { cost_category: "WASM_HOST_COST", cost: "READ_MEMORY_BYTE", gas_used: "1277247888" },
            {
              cost_category: "WASM_HOST_COST",
              cost: "READ_REGISTER_BASE",
              gas_used: "12585825930",
            },
            { cost_category: "WASM_HOST_COST", cost: "READ_REGISTER_BYTE", gas_used: "34201014" },
            {
              cost_category: "WASM_HOST_COST",
              cost: "STORAGE_HAS_KEY_BASE",
              gas_used: "54039896625",
            ...
            { cost_category: "WASM_HOST_COST", cost: "UTF8_DECODING_BASE", gas_used: "6223558122" },
            {
              cost_category: "WASM_HOST_COST",
              cost: "UTF8_DECODING_BYTE",
              gas_used: "25075921194",
            },
            { cost_category: "WASM_HOST_COST", cost: "WASM_INSTRUCTION", gas_used: "43072099356" },
            { cost_category: "WASM_HOST_COST", cost: "WRITE_MEMORY_BASE", gas_used: "16822769166" },
            { cost_category: "WASM_HOST_COST", cost: "WRITE_MEMORY_BYTE", gas_used: "988729236" },
            {
              cost_category: "WASM_HOST_COST",
              cost: "WRITE_REGISTER_BASE",
      ...
      outcome: {
        ...
        metadata: {
          ...
          gas_profile: [
            ...
            { cost_category: "WASM_HOST_COST", cost: "READ_MEMORY_BASE", gas_used: "7829589600" },
            { cost_category: "WASM_HOST_COST", cost: "READ_MEMORY_BYTE", gas_used: "589206615" },
            {
              cost_category: "WASM_HOST_COST",
              cost: "READ_REGISTER_BASE",
              gas_used: "10068660744",
            },
            { cost_category: "WASM_HOST_COST", cost: "READ_REGISTER_BYTE", gas_used: "24936186" },
            { cost_category: "WASM_HOST_COST", cost: "STORAGE_READ_BASE", gas_used: "56356845750" },
            {
              cost_category: "WASM_HOST_COST",
              cost: "STORAGE_READ_KEY_BYTE",
            ...
            { cost_category: "WASM_HOST_COST", cost: "WASM_INSTRUCTION", gas_used: "22824074196" },
            { cost_category: "WASM_HOST_COST", cost: "WRITE_MEMORY_BASE", gas_used: "14018974305" },
            { cost_category: "WASM_HOST_COST", cost: "WRITE_MEMORY_BYTE", gas_used: "732694668" },
            {
              cost_category: "WASM_HOST_COST",
              cost: "WRITE_REGISTER_BASE",
              gas_used: "17193134916",
