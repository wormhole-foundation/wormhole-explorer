...
describe("WormchainJsonRPCBlockRepository", () => {
  describe("healthCheck", () => {
    it("should be able to validate rpcs", async () => {
      ...
      // When
      const result = await repo.healthCheck("kujira", "immediate", 9187752n);

      // Then
      expect(result).toBeInstanceOf(Array);
      expect(result[0].isHealthy).toEqual(true);
      expect(result[0].height).toEqual(9187752n);
...
const givenARepo = () => {
  repo = new WormchainJsonRPCBlockRepository(
    ...
    },
    {
      ...
      kujira: {
        get: () => new InstrumentedHttpProvider({ url: rpc, chain: "kujira" }),
