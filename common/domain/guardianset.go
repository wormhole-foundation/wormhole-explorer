...
func GetMainnetGuardianSet() ([]common.GuardianSet, []time.Time) {
	...
	return []common.GuardianSet{gs0, gs1, gs2, gs3, gs4},
		[]time.Time{gs0ValidUntil, gs1ValidUntil, gs2ValidUntil, gs3ValidUntil, gs4ValidUntil}
}
...
func GetTestnetGuardianSet() ([]common.GuardianSet, []time.Time) {
	...
	return []common.GuardianSet{gstest0}, []time.Time{gs0TestValidUntil}
}
