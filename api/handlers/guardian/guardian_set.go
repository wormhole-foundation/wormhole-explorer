...
func getMainnetGuardianSet() GuardianSet {
	...
	return GuardianSet{
		GstByIndex:            []common.GuardianSet{gs0, gs1, gs2, gs3, gs4},
		ExpirationTimeByIndex: []time.Time{gs0ValidUntil, gs1ValidUntil, gs2ValidUntil, gs3ValidUntil, gs4ValidUntil},
	}
}
