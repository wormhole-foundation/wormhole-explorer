...
require (
	github.com/certusone/wormhole/node v0.0.0-20221118153622-cddfe74b6787
...
require (
	...
	github.com/wormhole-foundation/wormhole-explorer/spy v0.0.0-20221215155115-9f035b40bdfe
)
