...
// const ethTokenDatafilename = "/home/ceun/wh-research/projects/dashboard/src/data/ethTokenData.json"
// var tokenInfos = loadSavedData(ethTokenDatafilename)
//const tokenAddresses = tokenInfo.map(e=>e.tokenAddress)
//3. Make calls
// var func = async() => {
//   //let data = await CoinGeckoClient.ping();
//   //const tokenAddress = "0xa0b86991c6218b36c1d19d4a2e9eb0ce3606eb48"
//   for (let i = 0; i < tokenInfos.length; i++){
//     let tokenInfo = tokenInfos[i]
//     let tokenAddress = tokenInfo.tokenAddress
//     let tokenContractInfo = await CoinGeckoClient.coins.fetchCoinContractInfo(tokenAddress);
//     let data = tokenContractInfo['data']
//     var coinGeckoId = ''
//     var price = 0;
...
//     }
//     catch(e){
//       console.log('could not find cg id for address=', tokenAddress)
...
//       console.log('could not find price for address=', tokenAddress)
//     }
//     tokenInfos[i]['coinGeckoId'] = coinGeckoId
//     tokenInfos[i]['price'] = price

//     console.log('gonna sleep for 5 sec');
//     sleep(5*100)
//   }

//   require('fs').writeFile(

//     ethTokenDatafilename,
...
// getCoinGeckoMap().then(x=>console.log(x))
